public class BatailleFake {
    ...
    public static void main(String[] params) {
        ...
        for (int i = 0; i <= 3; i++) {
            ...
            caracteristicDuBateau[i] = Pep8.chari();
            System.out.print(caracteristicDuBateau[i]);
        ...
        int indiceDeRangeeFinal = (int) (rangeePositionBateau) - 48;
                    ...
                    switch (checkTaille(grandeurDuBateau)) {
                        ...
                        case 'g':
                            ...
                            if (checkOriontation(orientationDuBateau) == 'h') {
                                //Pep8.stro(">>>>>");
                                for (int i = 0; i < 5; i++) {
                                    Pep8.charo(situationInitiale[rangeePositionBateau][colonnePositionBateauFinal + i] = '>');
                                }
                            } else if (checkOriontation(orientationDuBateau) == 'v') {
                                for (int i = 0; i < 5; i++) {
                                    Pep8.charo(situationInitiale[rangeePositionBateau + i][colonnePositionBateauFinal] = 'v');
                                    //Pep8.charo('v');
                                    Pep8.charo('\n');
                                }
                            }
